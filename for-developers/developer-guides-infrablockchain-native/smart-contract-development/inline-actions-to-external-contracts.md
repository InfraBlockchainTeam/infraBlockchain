...
* [Linking Custom Permissions](creating-and-linking-custom-permissions.md): Learn how create a custom permission and how to link the permission to an action of a contract.
